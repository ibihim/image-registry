...
func verifyWithSAR(ctx context.Context, attrs *authorizationapi.ResourceAttributes, c client.SelfSubjectAccessReviewsNamespacer) error {
...
func verifyWithLocalSAR(ctx context.Context, resource, namespace, name, verb string, c client.SelfSubjectAccessReviewsNamespacer) error {
	attrs := &authorizationapi.ResourceAttributes{
		Namespace: namespace,
		Verb:      verb,
		Group:     imageapi.GroupName,
